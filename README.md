...
<!-- ✏️ Update the typing SVG text to change your animated headline -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&width=700&lines=Hi+%F0%9F%91%8B%2C+I'm+Sravanthi+Yedla;Data+Science+%7C+Data+Engineering;Power+BI+%7C+Python+%7C+SQL+%7C+Cloud;Building+real-world+solutions+%F0%9F%9A%80)](https://git.io/typing-svg)

<img src="https://capsule-render.vercel.app/api?type=waving&color=6C63FF&height=120&section=header&text=Welcome+to+my+GitHub!&fontSize=30&fontColor=ffffff&animation=fadeIn" width="100%"/>
...
![OOP](https://img.shields.io/badge/Object_Oriented_Programming-6C63FF?style=for-the-badge)
![DBMS](https://img.shields.io/badge/DBMS-6C63FF?style=for-the-badge)
...
- 📌 Pivot tables + dynamic visualizations for task status monitoring
- 🔗 Deployed via SharePoint for real-time collaborative access
- 👥 Enables managers to track employee performance at a glance
...
| Project | Description |
|---|---|
| 🏷️ Brand Name Generator | Auto-generates creative brand names |
| 💰 Tip Calculator | Smart bill-splitting utility |
| ✊ Rock-Paper-Scissors Game | Classic game with logic flow |
| 🏝️ Treasure Island Game | Text-based adventure game |
...
| 🏅 Achievement | Details |
|---|---|
| 🥇 GeeksForGeeks Rank | **87th Rank** on the platform |
| 💡 Hackathon | Participated in **GeeksForGeeks Hackathon** |
| 🐍 Python Certificate | Core Python Programming |
| 💻 C Certificate | C Language Fundamentals |
| ☁️ AWS Cloud Computing | Amazon Web Services |
| ❄️ Snowflake Certificate | Snowflake Data Platform |
